...
\renewcommand{\lettersectiontitleabout}{Minusta}
\renewcommand{\lettersectiontitlewhycompany}{Miksi \companyname?}
\renewcommand{\lettersectiontitlewhyme}{Miksi juuri minä?}
...
\renewcommand{\letterbody}{%
  \lettersection{\lettersectiontitleabout}
  ...
  \lettersection{\lettersectiontitlewhycompany}
  ...
  \lettersection{\lettersectiontitlewhyme}
