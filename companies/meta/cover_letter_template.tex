...
% Load company-specific information
...
% Set language and date based on company file (now contains cover letter config)
% Expand \letterdatelanguage to get its value, then check
...
% Check if \letterdate equals "auto" and replace with \today if so
...
% %----------HEADING-----------------
% Use company-specific title if available, otherwise use default
